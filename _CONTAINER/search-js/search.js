...
const output = require("./utils/output.js.js");
const usageUtil = require("./utils/usage.js.js");
const { promisify } = require("util");
const glob = promisify(require("glob"));
const readFile = promisify(fs.readFile);
const didYouMean = require("./utils/did-you-mean.js.js");
const { cmdList } = require("./utils/cmd-list.js.js");

const usage = usageUtil("help-search", "npm help-search <text>");
const completion = require("./utils/completion/none.js.js");

const npmUsage = require("./utils/npm-usage.js.js");
