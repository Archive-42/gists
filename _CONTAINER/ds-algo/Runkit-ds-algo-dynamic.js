...
console.log(
  `------------------ when the target is contained in the array----------should return true--------------------`
);
...
console.log(
  `------------------ when the target is contained in the array----------should return the index of where the target is found--------------------`
);
...
console.log(
  `--------------------when the target is not contained in the array-------------should return -1 ---------------`
);
