...
- This guide is both for beginners and the experienced. The goals are _breadth_ (everything important), _specificity_ (give concrete examples of the most common case), and _brevity_ (avoid things that aren't essential or digressions you can easily look up elsewhere). Every tip is essential in some situation or significantly saves time over alternatives.
...
This work is licensed under a [Creative Commons Attribution-ShareAlike 4.0 International License](http://creativecommons.org/licenses/by-sa/4.0/). I
