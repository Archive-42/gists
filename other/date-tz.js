...
function createRemoteDate (remoteLocaleIsoString, timeZone) {
  ...
  let dThere = new Date( new Date(remoteLocaleIsoString)
...
function createRemoteDate_test () {
  if (!(
    createRemoteDate('2020-03-28T19:00:00','America/Lima')
      .toLocaleString('af','Europe/Madrid') === '2020-03-29 01:00:00' &&
    createRemoteDate('2020-03-28T20:00:00','America/Lima')
    .toLocaleString('af','Europe/Madrid') === '2020-03-29 03:00:00' &&
    createRemoteDate('2020-03-28T21:00:00','America/Lima')
      .toLocaleString('af','Europe/Madrid') === '2020-03-29 04:00:00'
...
const dateToLocaleObj = (dateArg, locale='en-US', timeZone) => {
  ...
  let tmp = str.replace(/\s/g,'').replace(/(\/|,|:)/g,'-').split('-')
  ...
  let obj = {
    ...
    weekDay : weekDayNumbers[ date.toLocaleString('en-US',{weekday:'short', timeZone}) ],
