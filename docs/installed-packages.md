    ...
    initramfs-tools-bin/focal-updates,now 0.136ubuntu6.3 amd64 [installed,automatic]
    ...
    libpq-dev/focal-updates,focal-security,now 12.6-0ubuntu0.20.04.1 amd64 [installed]
    ...
    locales/focal-updates,now 2.31-0ubuntu9.2 all [installed,automatic]
    ...
    python3-docopt/focal,now 0.6.2-2.2ubuntu1 all [installed,automatic]
    ...
    ruby-minitest/focal,now 5.13.0-1 all [installed,automatic]
    ...
    syslinux-common/focal,now 3:6.04~git20190206.bf6db5b4+dfsg1-2 all [installed,automatic]
    ...
    systemd-sysv/focal-updates,now 245.4-4ubuntu3.4 amd64 [installed,automatic]
    systemd-timesyncd/focal-updates,now 245.4-4ubuntu3.4 amd64 [installed,automatic]
    systemd/focal-updates,now 245.4-4ubuntu3.4 amd64 [installed,automatic]
    ...
    tmux/focal-updates,focal-security,now 3.0a-2ubuntu0.2 amd64 [installed,automatic]
    tpm-udev/focal,now 0.4 all [installed,automatic]
    tree/focal,now 1.8.0-1 amd64 [installed]
    tzdata/focal-updates,focal-security,now 2021a-0ubuntu0.20.04 all [installed,automatic]
    ...
    udev/focal-updates,now 245.4-4ubuntu3.4 amd64 [installed,automatic]
    ...
    update-manager-core/focal-updates,now 1:20.04.10.6 all [installed,automatic]
    update-motd/focal-updates,now 3.6-0ubuntu6.1 all [installed]
    update-notifier-common/focal-updates,now 3.192.30.5 all [installed,automatic]
    ...
    vagrant-libvirt/focal,now 0.0.45-2 all [installed,automatic]
    vagrant/focal-updates,now 2.2.6+dfsg-2ubuntu3 all [installed]
    ...
    vim/focal,now 2:8.1.2269-1ubuntu5 amd64 [installed,automatic]
    ...
    xml-core/focal,now 0.18+nmu1 all [installed,automatic]
    xonsh/focal,now 0.9.13+dfsg-2 all [installed,automatic]
    ...
    zlib1g-dev/focal-updates,now 1:1.2.11.dfsg-2ubuntu1.2 amd64 [installed]
    zlib1g/focal-updates,now 1:1.2.11.dfsg-2ubuntu1.2 amd64 [installed,automatic]
    |01:12:14|bryan@LAPTOP-9LGJ3JGS:[apt] apt_exitstatus:0__________________________________________________________o>
